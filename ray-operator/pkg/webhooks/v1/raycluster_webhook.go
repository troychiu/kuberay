...
func (w *RayClusterWebhook) ValidateCreate(_ context.Context, obj *rayv1.RayCluster) (admission.Warnings, error) {
	rayCluster := obj
...
func (w *RayClusterWebhook) ValidateUpdate(_ context.Context, _ *rayv1.RayCluster, newObj *rayv1.RayCluster) (admission.Warnings, error) {
	rayCluster := newObj
