...
func (w *RayJobWebhook) ValidateCreate(_ context.Context, obj *rayv1.RayJob) (admission.Warnings, error) {
	rayJob := obj
...
func (w *RayJobWebhook) ValidateUpdate(_ context.Context, _ *rayv1.RayJob, newObj *rayv1.RayJob) (admission.Warnings, error) {
	rayJob := newObj
