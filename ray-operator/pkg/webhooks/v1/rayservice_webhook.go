...
func (w *RayServiceWebhook) ValidateCreate(_ context.Context, obj *rayv1.RayService) (admission.Warnings, error) {
	rayService := obj
...
func (w *RayServiceWebhook) ValidateUpdate(_ context.Context, _ *rayv1.RayService, newObj *rayv1.RayService) (admission.Warnings, error) {
	rayService := newObj
